...
- [x] Surface an explicit dismissible recovery notice after engine fatal/crash restart
...
## Status
**Integration-ready with recovery UX; external validation pending** — Restart shadow state tracks current bytes and a fatal/crash now raises a persistent, dismissible automatic-recovery alert.
